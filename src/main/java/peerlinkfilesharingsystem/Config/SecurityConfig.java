        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
            return http
                    ...
                    .authorizeHttpRequests(request -> {
                        ...
                        request.requestMatchers("/logs/latest","logs/download").permitAll();
                        request.requestMatchers("/api/login", "/api/register", "/api/discovery/announce").permitAll();
                        request.requestMatchers("/files/download/*/public", "/files/info/public/*").permitAll();
                        request.requestMatchers("/api/login", "/api/register", "/api/discovery/announce", "/api/requests/pending/guest").permitAll();
                        request.requestMatchers("/files/download/*/public", "/files/info/public/*").permitAll();
                        request.requestMatchers("/api/mail/forgotpassword").authenticated();
                        request.requestMatchers("/files/upload").authenticated();
                        request.requestMatchers("/files/download/**").authenticated();
